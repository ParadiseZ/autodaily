...
data class ScriptInfo(
    ...
    @ColumnInfo(name = "Script_Version") var scriptVersion: String, //是否选中
    @ColumnInfo(name = "Last_Version") val lastVersion : String,   //游戏的id
    @ColumnInfo(name = "Checked_Flag") var checkedFlag : String,     //脚本版本号
    @ColumnInfo(name = "Expiration_Time") var expirationTime : String,    //到期时间
    @ColumnInfo(name = "Package_Name") val packageName : String?, //包名
    @ColumnInfo(name = "Runs_Max_Num") var runsMaxNum : Int, //最大运行次数
